...
export function getAnimes(body) {
    return __awaiter(this, void 0, void 0, function () {
        var config, result, animeList;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    config = createConfig();
                    return [4 /*yield*/, instance.post('https://graphql.anilist.co', body, config)];
                case 1:
                    result = _a.sent();
                    animeList = result.data.data.Page.media;
...
export function createGraphQLQuery(animeIdArray, score) {
    var query = "query ($score: Int, $page: Int, $perPage: Int, $id_array: [Int]) { \n    Page (page: $page, perPage: $perPage){\n\n        media(averageScore_greater: $score, id_not_in: $id_array, type: ANIME){\n            id\n\n            title {\n                english,\n                romaji\n            }\n            genres\n            coverImage{\n                large\n            }\n            description\n            averageScore\n            \n        }\n\n    }\n  \n}\n";
    var variables = {
        score: score,
        page: 1,
        perPage: 50,
